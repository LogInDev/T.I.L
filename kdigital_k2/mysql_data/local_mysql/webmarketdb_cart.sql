...
CREATE TABLE `cart` (
  ...
  CONSTRAINT `cart_FK_1` FOREIGN KEY (`memberId`) REFERENCES `member` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `cart_FK_2` FOREIGN KEY (`productId`) REFERENCES `product` (`p_id`) ON DELETE CASCADE ON UPDATE RESTRICT
...
INSERT INTO `cart` VALUES (79,'whang',120,'1','S','red'),(81,'admin',101,'1','S','red');
