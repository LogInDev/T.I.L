...
int pageSize = 10;
int blockPage = 10;
int totalPage = (int)Math.ceil((double)totalCount / pageSize);//101 / 10 => 올림
...
<table border="1" width="90%">
	...
	<tr>
		...
		<th width="15%">작성일</th>
		<%
	if(session.getAttribute("UserId").equals("musthave")){
%>
		<th width="15%">수정</th>
		<th width="15%">삭제</th>
<%} %>
...
<%
	if(session.getAttribute("UserId").equals("musthave") && session.getAttribute("UserId") != null){
%>		
