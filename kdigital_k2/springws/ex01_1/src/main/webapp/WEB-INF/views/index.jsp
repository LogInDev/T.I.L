	...
	<div class="offcanvas-menu-wrapper">
		...
		<div class="offcanvas__nav__option">
			<a href="#" class="search-switch"><img
				...
				src="resources/img/icon/heart.png" alt=""></a> <a href="#"><img
				src="resources/img/icon/cart.png" alt=""> <span>0</span></a>
					...
					<div class="col-lg-6 col-md-5">
						<div class="header__top__right">
							...
							<div class="header__top__hover">
								<span>언어변경 <i class="arrow_carrot-down"></i></span>
								<ul>
									<li>KOR</li>
									<li>EUR</li>
									<li>USD</li>
			...
			<div class="row">
				<div class="col-lg-3 col-md-3">
					<div class="header__logo">
						<a href="./index.html"><img src="resources/img/logo.png?after"
							alt=""></a>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<ul class="filter__controls">
						<li class="active" data-filter="*">클래식</li>
						<li data-filter=".new-arrivals">플래시&라이트</li>
						<li data-filter=".hot-sales">프리미엄</li>
					</ul>
				</div>
			</div>
			<div class="row product__filter">
				<div
					...
					<div class="product__item">
						<div class="product__item__pic set-bg"
							data-setbg="resources/img/product/product-1.png">
							<span class="label">New</span>
							<ul class="product__hover">
								<li><a href="#"><img src="resources/img/icon/heart.png"
										alt=""></a></li>
								<li><a href="#"><img
										src="resources/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
								<li><a href="#"><img
										src="resources/img/icon/search.png" alt=""></a></li>
							</ul>
						</div>
				...
				<div
					...
					<div class="product__item">
						<div class="product__item__pic set-bg"
							data-setbg="resources/img/product/product-2.png">
							<ul class="product__hover">
								<li><a href="#"><img src="resources/img/icon/heart.png"
										alt=""></a></li>
								<li><a href="#"><img
				...
				<div
					...
					<div class="product__item sale">
						<div class="product__item__pic set-bg"
							data-setbg="resources/img/product/product-3.png">
				...
				<div
					...
					<div class="product__item">
						<div class="product__item__pic set-bg"
							data-setbg="resources/img/product/product-4.png">
							<ul class="product__hover">
								<li><a href="#"><img src="resources/img/icon/heart.png"
										alt=""></a></li>
								<li><a href="#"><img
				...
				<div
					...
					<div class="product__item">
						<div class="product__item__pic set-bg"
							data-setbg="resources/img/product/product-5.png">
							<ul class="product__hover">
								<li><a href="#"><img src="resources/img/icon/heart.png"
										alt=""></a></li>
								<li><a href="#"><img
				...
				<div
					...
					<div class="product__item sale">
						<div class="product__item__pic set-bg"
							data-setbg="resources/img/product/product-6.png">
							<span class="label">Sale</span>
							<ul class="product__hover">
								<li><a href="#"><img src="resources/img/icon/heart.png"
										alt=""></a></li>
				...
				<div
					...
					<div class="product__item">
						<div class="product__item__pic set-bg"
							data-setbg="resources/img/product/product-7.png">
							<ul class="product__hover">
								<li><a href="#"><img src="resources/img/icon/heart.png"
										alt=""></a></li>
								<li><a href="#"><img
				...
				<div class="col-lg-8">
					<div class="instagram__pic">
						<div class="instagram__pic__item set-bg"
							data-setbg="resources/img/instagram/instagram-1.jpg"></div>
						<div class="instagram__pic__item set-bg"
							data-setbg="resources/img/instagram/instagram-2.jpg"></div>
						<div class="instagram__pic__item set-bg"
							data-setbg="resources/img/instagram/instagram-3.jpg"></div>
						<div class="instagram__pic__item set-bg"
							data-setbg="resources/img/instagram/instagram-4.jpg"></div>
						<div class="instagram__pic__item set-bg"
							data-setbg="resources/img/instagram/instagram-5.jpg"></div>
						<div class="instagram__pic__item set-bg"
							data-setbg="resources/img/instagram/instagram-6.jpg"></div>
					</div>
				</div>
				<div class="col-lg-4">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="blog__item">
						<div class="blog__item__pic set-bg"
							data-setbg="resources/img/blog/blog-1.jpg"></div>
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="blog__item">
						<div class="blog__item__pic set-bg"
							data-setbg="resources/img/blog/blog-2.jpg"></div>
						<div class="blog__item__text">
							<span><img src="resources/img/icon/calendar.png" alt="">
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					<div class="blog__item">
						<div class="blog__item__pic set-bg"
							data-setbg="resources/img/blog/blog-3.jpg"></div>
						<div class="blog__item__text">
							<span><img src="resources/img/icon/calendar.png" alt="">
